  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col items-center justify-center px-6 py-16">
      <div className="w-full max-w-form text-center flex flex-col items-center gap-6">
        <div className="flex items-center justify-center w-20 h-20 rounded-full bg-accent-light border border-accent/20 text-4xl mb-2" aria-hidden="true">✨</div>
        ...
        <div className="w-full bg-surface rounded-2xl border border-border shadow-sm p-8 flex flex-col items-center gap-3">
          ...
          <p className="text-[2.25rem] font-semibold text-accent tracking-tight leading-tight" style={{ fontVariant: 'small-caps' }}>
            {alias}
          </p>
        ...
        <div className="flex items-start gap-3 w-full rounded-xl bg-accent-light border border-accent/20 px-4 py-3.5 text-left">
          ...
          <p className="text-xs text-accent leading-relaxed">{t('success.privacy')}</p>
        </div>

        <Link to="/" className="inline-flex items-center gap-2 text-sm text-muted hover:text-primary transition-colors duration-200 mt-2">
          {/* Back arrow — flipped in RTL */}
          <svg
